...
async def relatorio_command(update, context):
    ...
    prompt = f"""
Você é coach de endurance e cientista de dados de performance. Não utilize: ** -- ## Markdown, utilize apenas texto puro para não consumir o limite de caracteres do telegram, ou seja, ajuste o relatório para no máximo 3750 caracteres, considerando espaços e emojis. 
